...
def main():
    ...
    plt.plot(template[0], template[1], label="template", color='r')
    plt.plot(data[0], data[1], label="data", color='k')
    plt.plot(result[0], result[1], label="result: "+str(rotation)+"° - "+str([dx,dy]), color='g')
